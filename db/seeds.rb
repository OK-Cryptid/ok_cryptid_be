...
big_foot = Cryptid.create(name: "Big Foot", range: "Rocky Mountains, Appalachian Trial, Coastal Plain", danger_level: "6", image: "https://m.media-amazon.com/images/M/MV5BZTdlMzI2MGYtMTZkNi00OWUyLTk2YWEtNTdmYzRiNjlhM2QyXkEyXkFqcGdeQXVyMjU0MzA2NjM@._V1_.jpg", description: "Sasquatch, also called Bigfoot, (from Salish se’sxac: “wild men”) a large, hairy, humanlike creature believed by some people to exist in the northwestern United States and western Canada. It seems to represent the North American counterpart of the Himalayan region’s mythical monster, the Abominable Snowman, or Yeti.")
