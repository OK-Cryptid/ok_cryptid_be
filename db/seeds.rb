...
big_foot_sighting = big_foot.sightings.create(location: "Your mom's house", description: "sighting description 1", image: "sighting image 1", title: "title 1 ", trail_links: ["thisway.com", "bigfootspotted.com"])
