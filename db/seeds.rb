...
chupacabra = create(:cryptid, name: "Chupacabra", range: "Southwestern US, Puerto Rico, Maine", image: "https://bit.ly/3wGyYov",
...
# bigfoot
bfoot_sighting_1 = create(:sighting, cryptid: bigfoot, location: 'Buchers Mills, PA', description: "Spotted Bigfoot along the highway near millstone. Described the creature as having looked back at them on the shoulder of the road — an encounter that ultimately lasted seconds", image: "https://media.tegna-media.com/assets/WATN/images/3dc105e5-a10b-4a3a-aa74-1e4544f8f0b2/3dc105e5-a10b-4a3a-aa74-1e4544f8f0b2_1140x641.jpgsighting",
                                     trail_links: ["https://www.alltrails.com/explore/trail/us/pennsylvania/chapman-nature-trail?ref=result-card", "https://www.alltrails.com/explore/trail/us/pennsylvania/adams-run-trail"])

bfoot_sighting_2 = create(:sighting, cryptid: bigfoot, description: 'A youth group was camping in the Marble Mountain Wilderness when leader Jim Mills noticed a strange-looking creature skulking along a ridge nearby.', location: "Leadville, CO", trail_links: ["https://www.alltrails.com/explore/trail/us/colorado/boulders-and-giddy-up-loop", "https://www.alltrails.com/explore/trail/us/colorado/mineral-belt-trail"])
bfoot_sighting_3 = create(:sighting, cryptid: bigfoot, description: 'A hiker was walking when he spotted a large creature to the left in the woods. As he approached, the creature stood up on two legs and started throwing rocks at him.', location: "Roosevelt, Utah", trail_links: ["https://www.alltrails.com/explore/trail/us/utah/hidden-lake-via-duck-lake-trail-210", "https://www.alltrails.com/explore/trail/us/utah/crystal-lake-loop--2"])

# mothman
mman_sighting_1 = create(:sighting, cryptid: mothman, description: 'Five gravediggers claimed to see a human-like figure soaring just above them in the autumn trees.', location: "Point Pleasant, West Virgina", trail_links: ["https://www.alltrails.com/explore/trail/us/west-virginia/point-plesant-walkin-trail"])
mman_sighting_2 = create(:sighting, cryptid: mothman, description: 'A man was driving along State Route 2 saw something jump from tree to tree. He pulled off the road and snapped some pictures. In the pictures, the creature appears to have wings with pointed tips and long legs, bent at an awkward angle.', location: 'Point Pleasant, West Virgina', trail_links: ["https://www.alltrails.com/explore/trail/us/west-virginia/point-plesant-walkin-trail"])
mman_sighting_3 = create(:sighting, cryptid: mothman, description: 'A man saw something that resembled a humanoid pterodactyl flying awkwardly.', location: 'Chicago, IL', trail_links: ["https://www.alltrails.com/explore/trail/us/illinois/chicago-riverwalk", "https://www.alltrails.com/explore/trail/us/illinois/millennium-park-trail"])

# nightcrawler
ncrawler_sighting_1 = create(:sighting, cryptid: nightcrawler, description: 'A man put up trail cameras in his yard to see what was causing his dogs to bark during the night. The cameras captured images of strange pale, small, armless creatures walking.', location: "Old Bretz Mill, California", trail_links: ["https://www.alltrails.com/explore/trail/us/california/granite-ridge-loop", "https://www.alltrails.com/explore/trail/us/california/shaver-lake-trail"])
ncrawler_sighting_2 = create(:sighting, cryptid: nightcrawler, description: 'A 17 year old motorist saw a strange thing on the side of the road when driving at night. It was thin and pale with long legs, and moved oddly as if disjointed.', location: "Hesperia, CA", trail_links: ["https://www.alltrails.com/explore/trail/us/california/coxey-rd", "https://www.alltrails.com/explore/trail/us/california/mount-san-antonio-mount-baldy-notch-trail"])
ncrawler_sighting_3 = create(:sighting, cryptid: nightcrawler, description: 'A video captured on home surveillance system shows a white creature with long legs and no upper body walking slowly across the yard.', location: "Fullerton, CA", trail_links: ["https://www.alltrails.com/explore/trail/us/california/mount-san-antonio-mount-baldy-notch-trail", "https://www.alltrails.com/explore/trail/us/california/juanita-cooke-trail-to-hitscher-park-trail"])

# chupacabra
chcabra_sighting_1 = create(:sighting, cryptid: chupacabra, description: 'A woman spotted a creature standing upright, resembling a reptilian kangaroo with huge red eyes. It ran into the brush when she screamed. Later, the livestock on the property were found to be dead. They were not eaten or mutilated, but were drained of blood.', location: "Arecibo, Puerto Rico", trail_links: ["https://www.alltrails.com/explore/trail/puerto-rico/northern-region/charco-prieto-water-falls?u=i"])
chcabra_sighting_2 = create(:sighting, location: "Bangor, Maine", trail_links: ["https://www.alltrails.com/explore/trail/us/maine/brewer-riverwalk"], cryptid: chupacabra, description: 'Two seven year old boys described seeing a dog-like creature with a row of spines down its back standing on its hind legs near the barn. Six of the family goats were found drained of blood approximately 40 feet away from where the creature had been lurking.')
...
# tommyknocker
tknocker_sighting_1 = create(:sighting, cryptid: tommyknocker,
...
# skinwalker
swalker_sighting_1 = create(:sighting, cryptid: skinwalker,
...
swalker_sighting_2 = create(:sighting, cryptid: skinwalker,
...
swalker_sighting_3 = create(:sighting, cryptid: skinwalker,
...
# alien
alien_sighting_1 = create(:sighting, cryptid: alien,
